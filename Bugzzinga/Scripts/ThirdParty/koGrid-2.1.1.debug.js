    ...
    self.buildColumns = function () {
        ...
        if (self.config.displaySelectionCheckbox && self.config.canSelectRows) {
            columnDefs.splice(0, 0, {
                ...
                sortable: false,
                resizable: false,
                headerCellTemplate: '<label class="checkbox"><input class="kgSelectionHeader" type="checkbox" data-bind="visible: $grid.multiSelect, checked: $grid.allSelected"/></lablel>',
                cellTemplate: '<div class="kgSelectionCell"><label class="checkbox"><input class="kgSelectionCheckbox" type="checkbox" data-bind="checked: $parent.selected" /></lablel></div>'
            });
        }
