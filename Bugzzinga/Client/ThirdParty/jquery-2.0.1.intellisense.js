intellisense.annotate(jQuery, {
  ...
  'proxy': function() {
    ...
    ///   <param name="function" type="Function">The function whose context will be changed.</param>
    ///   <param name="context" type="PlainObject">The object to which the context (this) of the function should be set.</param>
    ///   <param name="additionalArguments" type="Anything">Any number of arguments to be passed to the function AuthReferenced in the function argument.</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular context.</summary>
...
intellisense.annotate(_object, {
  ...
  'fireWith': function() {
    ...
    ///   <param name="context" type="">A AuthReference to the context in which the callbacks in the list should be fired.</param>
...
intellisense.annotate(jQuery.fn, {
  ...
  'replaceAll': function() {
    ...
    ///   <param name="target" type="">A selector string, jQuery object, or DOM element AuthReference indicating which element(s) to replace.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
